   ...
   return (
      <>
         <div className="item-center p-4">
            <h2 className="text-center dark:text-white text-slate-600 text-[28px] mb-8">
               Products
            </h2>
            <table className="border-collapse table-auto w-full">
               ...
               <tbody className="text-center bg-white dark:bg-slate-800">
                  {eventLists.map((event, index) => (
                     <tr
                        className="h-[160px] border-b border-slate-600"
                        key={event.id}
                     >
                        <td>{index + 1}</td>
                        <td>{event.id}</td>
                        ...
                        <td>
                           {event.eventDate.eventStartDate
                              ?.toDate()
                              ?.toLocaleDateString()}
                        </td>
                        <td>
                        ...
                        <td>
                           <div className="flex flex-col items-center gap-2">
                              ...
                              <Link
                                 href={`admin/products/details/${event.id}`}
                              ...
                              <Link
                                 href={`admin/products/edit/${event.id}`}
