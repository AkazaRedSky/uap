...
function TopUp() {
  ...
  return (
      ...
      <h1 className="text-center text-3xl font-semibold text-white-75 text-[28px] mb-8">Top Up</h1>
      {alert && <p>{alert}</p>}
      <form onSubmit={handleSubmit}>
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <label htmlFor="amount" className="block text-sm font-medium leading-6 text-slate-500">
                Amount:
              </label>
              <div className="mt-2">
