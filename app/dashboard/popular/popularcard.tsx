...
import './popular.css';
import ApplicationPrice from "./popularprice";
...
const PopularCard = ({ id, image, title, tags, price, discountpercentage }: PopularCardType) => {
  return (
    <>    
        <a href={`/products/${id}`} className="tab_item app_impression_tracked">
            <div className="tab_item_cap" style={{width: 184,height: 69}}>
                ...
                <ApplicationPrice price={price} discountpercentage={discountpercentage} />
            <div className="tab_item_content">
                <div className="tab_item_name">
                    {title}
                </div>
