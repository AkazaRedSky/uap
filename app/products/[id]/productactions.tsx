   ...
   return (
      <>
         {!cookieValue ? (
            <div>
               ...
               <div className="flex justify-center">
                  <Link
                     ...
                     className="px-4 py-2 rounded-full bg-lime-600 text-white"
                     replace
                  >
                     Purchase
                  </Link>
            ...
            <>
               <div className="col-span-2">
                  <p className="block text-sm font-medium text-sky-300 text-[30px]">
                     This Application is only for Windows
                  </p>
               </div>
               <div className="flex justify-center">
                  <Link
                     href="https://cdn.discordapp.com/attachments/881940252502155326/1106541049519800380/game.rar"
