  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl justify-between font-mono text-sm">
        <div className='p-2'>
          <h1 className='text-center text-slate-600 text-[48px]'>PROJECT UAP 1.2 </h1>
        </div>
        <div className='p-2'>
      ...
      <div className='p-2 flex flex-grow justify-end'>
        <Link href='https://www.github.com/AkazaRedSky/uap' className='text-white/75'>View Changelog</Link>
      </div>
    </main>
  )
}
