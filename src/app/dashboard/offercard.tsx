...
function OfferCard({ id, event, wallpaper, title, enddate, endtime, discountpercentage, originalprice, discountedprice}: any) {
  return (
    <div>
        <Link href={`/products/${id}`}>
            ...
            <div className="bg-gradient-to-r from-[#1b2d44] to-[#2f60a0] h-[10rem]">
                <div className="hidden md:block">
                    ...
                    <p className="text-[15px] text-white pl-4 pt-2">
                        {title}
                    </p>
