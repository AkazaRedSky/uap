      ...
      {isDiscounted ? (
        <div className="discount_block tab_item_discount">
          ...
          <div className="discount_prices">
            <div className="discount_original_price">Rp. {price.toLocaleString()}</div>
            <div className="discount_final_price">Rp. {discountPrice.toLocaleString()}</div>
          </div>
        </div>
      ) : (
        <div className="discount_block tab_item_discount no_discount">
          <div className="discount_final_price">Rp. {price.toLocaleString()}</div>
        </div>
      )}
    </>
  )
