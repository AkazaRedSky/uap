...
function Welcome() {
  ...
  <>
    {user ? (
            ...
            <Link href='/payment/topup' className={buttonVariants({variant: 'ghost'})}>
                Top Up
            </Link>
            </div> 
            <Menu as="div" className="md:flex gap-4 items-center mr-5">
                  ...
                  >
                    ...
                    <Menu.Item>
                          <p
                            className='block px-4 py-2 text-sm text-white/75'
                          >
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <Link
                            href="#"
                            className={classNames(active ? 'bg-slate-300' : '', 'block px-4 py-2 text-sm text-white/75')}
                            prefetch={false}
                          >
                            Profile
                          </Link>
